...
export default function Profile() {
  ...
  return (
    <>
      <section className="da mt-10 flex items-center justify-center gap-x-12 ">
        <img
          src={profilePic}
          alt="user"
        ...
        <div className="flex flex-col justify-start px-2 max-[450px]:items-center ">
          ...
          <button
            ...
            disabled={isEditing}
            className={`mt-4 w-fit rounded-full border-2 border-lochmara-200 dark:divide-lochmara-500 px-3 py-2 dark:text-white  ${
          ...
          >
            ...
            >
              <div className="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
                ...
                bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-500 
                ...
                focus:ring-blue-500 dark:bg-gray-600 dark:text-white dark:border-gray-500
                "
                    required
                  />
                </div>
                ...
                bg-gray-50 p-2.5 
                text-sm text-gray-900 
                focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-600 dark:text-white dark:border-gray-500 "
                    required
                  />
                </div>
                {/* phonenumber */}
